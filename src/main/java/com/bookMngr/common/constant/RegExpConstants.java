package com.bookMngr.common.constant;

/**
 * description    : 정규식을 상수로 표현하는 클레스입니다.
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class RegExpConstants {
    ...
    public static final String REGEXP_NOT_SPECIAL_CHAR_TYPE3 = "[A-Za-z0-9가-힣]*$";
    ...
    // 3. 사용자 패스워드에 대한 정규식 - 대소문자 + 숫자 + 특수문자 조합으로 8 ~ 20자리로 정의 한다.
    ...
    public static final String REGEXP_PHONENUMBER_TYPE = "^01(?:0|1|[6-9])[.-]?(\\d{3}|\\d{4})[.-]?(\\d{4})$";
