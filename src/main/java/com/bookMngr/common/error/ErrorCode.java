...
public enum ErrorCode {
    ...
    ,STORE_ERROR_004(500, "EC1015", "삭제에 실패하였습니다.", "deleteResult가 1이 아닙니다.")
    ,STORE_ERROR_005(500, "EC1016", "매장 내 도서 정보 등록 실패", "존재하지 않는 도서정보 입니다.")
    ,STORE_ERROR_007(500, "EC1017", "도서 정보 에러 발생", "도서 정보 에러 발생")
